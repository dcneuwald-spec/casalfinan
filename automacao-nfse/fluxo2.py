"""
Fluxo 2 — Emissão automática todo dia 1°.
...
def executar():
    logger.info("=== FLUXO 2 INICIADO ===")

    dados = json.loads(Path("clientes_fluxo2.json").read_text(encoding="utf-8"))
